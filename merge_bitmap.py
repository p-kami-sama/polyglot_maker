...
def merge_bitmap_js(bitmap_file: str, js_code_file: str, output_file: str, verbose: bool = False):
    with open(js_code_file, 'r') as js_f:   # open .js file
        codigo = js_f.read()
...
"""
    ...
    with open(output_file, "wb") as f:
        ...
        f.write(code_data)  # Insert js code
...
# overwrite part of the image with the code
def merge_bitmap_js_overwrite(bitmap_file: str, js_code_file: str, output_file: str, verbose: bool = False):

    with open(js_code_file, 'r') as lua_f:   # open .js file
        codigo = lua_f.read()
...
"""
    ...
    with open(output_file, "wb") as f:
        ...
        f.write(new_bitmap_raw_image)  # Insert js code
